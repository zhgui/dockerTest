...
CREATE TABLE `business_user` (
  ...
  `updateTime` datetime DEFAULT NULL,
  `userCd` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `pcf_auth_t`
-- ----------------------------
DROP TABLE IF EXISTS `pcf_auth_t`;
CREATE TABLE `pcf_auth_t` (
  ...
  `SORT_KEY` varchar(15) NOT NULL,
  PRIMARY KEY (`AUTH_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of pcf_auth_t
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=10366 DEFAULT CHARSET=utf8 COMMENT='��Դ��';
...
INSERT INTO `pcf_resource_t` VALUES ('10360', '商户管理', '商户管理', '', '', '0', '3', '0', '2016-07-22 15:46:02', '0', '2016-07-22 15:46:02', 'fa fa-users', '1', '1/');
INSERT INTO `pcf_resource_t` VALUES ('10365', '商户管理', 'merchant', '/shop/server/merchant/list', '商户管理', '0', '5', '0', '2016-07-22 15:49:54', '0', '2016-07-22 15:49:54', null, '10360', '1/10360/');
...
CREATE TABLE `pcf_role_resource_permission` (
  ...
  `create_date` datetime NOT NULL COMMENT '������',
  PRIMARY KEY (`rrp_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1234 DEFAULT CHARSET=utf8 COMMENT='��ɫ��Դ��Ȩ��';

-- ----------------------------
-- Records of pcf_role_resource_permission
-- ----------------------------
INSERT INTO `pcf_role_resource_permission` VALUES ('1226', '109', '2', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
INSERT INTO `pcf_role_resource_permission` VALUES ('1227', '109', '3', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
INSERT INTO `pcf_role_resource_permission` VALUES ('1228', '109', '1300', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
INSERT INTO `pcf_role_resource_permission` VALUES ('1229', '109', '1350', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
INSERT INTO `pcf_role_resource_permission` VALUES ('1230', '109', '1351', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
INSERT INTO `pcf_role_resource_permission` VALUES ('1231', '109', '10304', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
INSERT INTO `pcf_role_resource_permission` VALUES ('1232', '109', '10303', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
INSERT INTO `pcf_role_resource_permission` VALUES ('1233', '109', '10365', '1100,1101,1102,1103,1104', '0', '2016-07-22 15:50:24');
...
-- ----------------------------
INSERT INTO `pcf_role_t` VALUES ('109', '系统管理员', 'admin', '系统管理员', '0', '1', '0', '2016-07-22 15:50:24', '0', '2016-07-22 15:50:24');

-- ----------------------------
-- Table structure for `pcf_task_t`
-- ----------------------------
DROP TABLE IF EXISTS `pcf_task_t`;
CREATE TABLE `pcf_task_t` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `GROUPS` varchar(300) DEFAULT NULL,
  `NAME` varchar(300) DEFAULT NULL,
  `REMARK` varchar(3000) DEFAULT NULL,
  `STATUS` int(11) DEFAULT NULL,
  `TIME_EXPRESSION_ID` varchar(10) DEFAULT NULL,
  `TIME_EXPRESSION_NAME` varchar(300) DEFAULT NULL,
  `TIME_EXPRESSION_VALUE` varchar(300) DEFAULT NULL,
  `TYPE` int(11) DEFAULT NULL,
  `VIEW_NAME` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of pcf_task_t
-- ----------------------------
