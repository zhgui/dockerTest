...
(function(){
    ...
    function initTabs(){
        ...
        for (var i = 0; i < tabs.length; i++) {
            domUtils.on(tabs[i], "click", function (e) {
                ...
                if(this.getAttribute('data-content-id')=='online'){
                	initOnlineImage();
                }
            });
        }
    ...
    function insertOnline(){
    	var onlineList=onlineImage.getInsertList();
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    img.width = 113;
                    img.setAttribute('src', urlPrefix + list[i].src + (list[i].url.indexOf('?') == -1 ? '?noCache=':'&noCache=') + (+new Date()).toString(36) );
