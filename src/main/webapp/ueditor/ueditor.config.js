...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: "/buddhaApp/"+"attach/ueditor/UEController"
        ...
        , toolbars: [[
            ...
            'simpleupload', 'insertimage', 'pagebreak',  'background', '|',
            'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|',
            'print', 'preview'
        ]]
        // 'insertvideo', 'music', 'gmap', 'webapp', , 'searchreplace', 'help', 'drafts' 'attachment', 'map', 'insertframe', 'template','scrawl', 'autotypeset','emotion', 'insertcode',
