...
<div class="row">
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" role="form" id="supportTypeForm">
            <input id="id" name="id" value="${supportType.id}" type="hidden">
            <input id="editStatus" name="editStatus" value="${supportType.status}" type="hidden">
            <div class="space-1"></div>
            <!-- #section:elements.form -->
            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right" for="name">名称<span style="color: red">*</span></label>
                <div class="col-sm-9">
                    <input type="text" id="name" name="name" value="${supportType.name}" placeholder="类型名称" class="col-xs-10 col-sm-5"/>
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right" for="sname">类型简称<span style="color: red">*</span></label>
                <div class="col-sm-9">
                    <input type="text" id="sname" name="sname" value="${supportType.sname}" placeholder="类型简称" class="col-xs-10 col-sm-5"/>
                </div>
            </div>
...
<script type="text/javascript">
	$(function(){
        ...
        $(".subm").on("click", function () {
            ...
            doPost("${ctx}/buddha/server/supporttype/updateSupportType", $("#supportTypeForm").serialize(), function (data) {
            	if (data.success) {
