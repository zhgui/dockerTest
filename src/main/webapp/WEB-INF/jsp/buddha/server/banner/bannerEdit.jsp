    ...
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" role="form" id="bannerForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="name" name="name" value="${banner.name}" placeholder="名称" class="col-xs-10 col-sm-5"/>
                </div>
            </div>
			...
			<div id="divCover" class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea id="path" name="path">${banner.path}</textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="url" name="url" value="${banner.url}" placeholder="跳转地址" class="col-xs-10 col-sm-5"/>
                </div>
            </div>
...
<script type="text/javascript">
	$(function(){
        $(".subm").on("click", function () {
            ...
            doPost("${ctx}/buddha/server/banner/updateBanner", $("#bannerForm").serialize(), function (data) {
            	if (data.success) {
