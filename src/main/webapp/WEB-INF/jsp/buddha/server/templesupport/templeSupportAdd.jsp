    ...
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" role="form" id="templeSupportForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="money" name="money" value="" placeholder="金额" class="col-xs-10 col-sm-5"/>
                </div>
            </div>            
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                     <textarea id="remark" name="remark" style="resize: none;width:365px;height:150px"></textarea>
                </div>
            </div>
...
$(document).ready(function () {
	...
	$(function(){
        ...
        $(".subm").on("click", function () {
            ...
            doPost("${ctx}/buddha/server/templesupport/insertTempleSupport", $("#templeSupportForm").serialize(), function (data) {
            	if (data.success) {
