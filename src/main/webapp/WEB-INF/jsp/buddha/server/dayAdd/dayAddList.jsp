            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <nobr><input style="width:180px" type="text"  name="startTime" onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endTime\')}'})"
                                   placeholder="开始时间" id="startTime" value="" />至
                            <input style="width:180px" type="text" name="endTime" onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'startTime\')}'})"
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        jQuery(grid_selector).jqGrid(jqGridOption({
            url:'${ctx}/buddha/server/dayAdd/list',
            datatype: "json",
            height: 350,
            shrinkToFit: false,
            colNames: ['供养次数','供养金额(元)','供养日期','供养类型'],
            colModel: [
                {name: 'sumCount', index: 'sumCount', width: 220, sorttype: "int",hidden:false},
                {name: 'sumMoney', index: 'sumMoney', width: 220, edittype: "string",hidden:false},
                {name: 'dateTime', index: 'dateTime', width: 220, sorttype: "string",hidden:false},
                {name: 'typeName', index: 'typeName', width: 320, sorttype: "string",hidden:false},
