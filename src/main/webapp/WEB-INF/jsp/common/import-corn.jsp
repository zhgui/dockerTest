...
<link href="${ctx}/static/plugin/cron/themes/bootstrap/easyui.css" rel="stylesheet" type="text/css" />
<link href="${ctx}/static/plugin/cron/themes/icon.css" rel="stylesheet" type="text/css" />
<link href="${ctx}/static/plugin/cron/icon.css" rel="stylesheet" type="text/css" />
<script src="${ctx}/static/plugin/cron/jquery.easyui.min.js" type="text/javascript"></script>
<script src="${ctx}/static/plugin/cron/cron.js" type="text/javascript"></script>
