...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form class="form-horizontal" role="form" id="permissionAddForm" action="${ctx}/pcf/permission/add">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="permissionName" name="permissionName" placeholder="权限名称"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="permission" name="permission" placeholder="权限标识符"
                           class="col-xs-10 col-sm-5"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="notes" name="notes" placeholder="权限描述" class="col-xs-10 col-sm-5"/>
                </div>
            </div>
            <div class="inputline inputline-dashed inputline-lg inputpull-in"></div>
...
<script type="text/javascript">
    $(function () {
        $('#permissionAddForm').validate(jValidateOption({
            rules: {
                permissionName: {
                    required: true,
                    maxlength: 300
        ...
        $(".saveBtn").on("click", function () {
            ...
            doPost("${ctx}/pcf/permission/add", $("#permissionAddForm").serialize(), function (data) {
                if (data.success) {
