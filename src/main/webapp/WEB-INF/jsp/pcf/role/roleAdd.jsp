...
<body class="no-skin" style="background-color: #fff;height:1000px;">
        ...
        <form class="form-horizontal" role="form" id="roleAddForm">
            <div class="well">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="roleName" name="roleName" placeholder="角色名称" class="col-xs-10 col-sm-5"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="role" name="role" placeholder="角色标识" class="col-xs-10 col-sm-5"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="notes" name="notes" placeholder="角色描述" class="col-xs-10 col-sm-5"/>
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <span>
                        <input name="deleteFlag" type="radio" class="ace" value="0" checked/>
                        <span class="lbl"> 有效 </span>
                    </span>
                    <span>
                        <input name="deleteFlag" type="radio" class="ace" value="1"/>
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $('#roleAddForm').validate(jValidateOption({
            rules: {
                roleName: {
                    required: true,
                    maxlength: 330
        ...
        $(".saveBtn").on("click", function () {
            ...
            doPost("${ctx}/pcf/role/addAndAuth", $("#roleAddForm").serialize(), function (data) {
                if (data.success) {
                    //addGritter("success", data.message, null, function () {
                    //    document.location.href = "${ctx}/pcf/role/toUpdate?roleId=" + data.data.permissionId;
            ...
            // $("#roleAddForm").attr("action", "${ctx}/pcf/role/addAndAuth").submit();
        });
    });
</script>
