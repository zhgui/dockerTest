    ...
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" role="form" id="taskForForm" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="name" name="name" value="${pcfTask.name}" placeholder="任务类" class="col-xs-10 col-sm-5"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="viewName" name="viewName" value="${pcfTask.viewName}" placeholder="任务名称" class="col-xs-10 col-sm-5"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="groups" name="groups" value="${pcfTask.groups}" placeholder="分组" class="col-xs-10 col-sm-5"/>
                </div>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-9">
                    <span>
                        <input id="isUseNo" name="status" type="radio" class="ace" value="1" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="timeExpressionName" name="timeExpressionName" value="${pcfTask.timeExpressionName}" placeholder="规则说明" class="col-xs-10 col-sm-5"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea id="remark" name="remark">${pcfTask.remark}</textarea>
...
jQuery(function($){
        ...
        $(".subm").on("click", function () {
        	...
        	doPost("${ctx}/pcf/task/taskUpdate", $("#taskForForm").serialize(), function (data) {
                if (data.success) {
