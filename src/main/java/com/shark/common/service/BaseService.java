 ...
 * <p>Version: 1.0
 */
public abstract class BaseService<M extends AbstractEntity, ID extends Serializable> implements IBaseService<M, ID> {
    ...
    public <T> List<T> findBySQL(String sql, Class<T> beanClass, Object... paras) {
        return baseRepository.findBySQL(sql, beanClass, paras);
    }

    public <T> List<T> findBySQL(String sql, Class<T> beanClass) {
        return baseRepository.findBySQL(sql, beanClass);

    }

    public <T> T findOneBySQL(String sql, Class<T> beanClass, Object... paras) {
        return baseRepository.findOneBySQL(sql, beanClass, paras);

    }

    public <T> T findOneBySQL(String sql, Class<T> beanClass) {
        return baseRepository.findOneBySQL(sql, beanClass);

    }

    public <T> T findValBySQL(String sql, Object... paras) {
        return (T)baseRepository.findValBySQL(sql, paras);
    }
