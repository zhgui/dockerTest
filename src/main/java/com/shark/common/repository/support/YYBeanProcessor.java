 ...
 * @since DbUtils 1.1
 */
public class YYBeanProcessor extends BeanProcessor {

    public static final BeanProcessor defaultProcessor = new YYBeanProcessor();
    /**
     ...
     * @since 1.5
     */
    public YYBeanProcessor(Map<String, String> columnToPropertyOverrides) {
        super();
