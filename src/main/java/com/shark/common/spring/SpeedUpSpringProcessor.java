 ...
 *
 */
package com.shark.common.spring;
...
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if(className.equals("com.shark.common.repository.support.SimpleBaseRepositoryFactoryBean") ||
    ...
    public static void main(String[] args) {
        String c = "com.shark.sys.user.web.bind.A";
    }
}
